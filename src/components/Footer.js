    ...
    <div className='footer-container'>
      ...
      <div class='footer-links'>
        ...
        <div className='footer-link-wrapper'>
          ...
          <div class='footer-link-items'>
            <h2>Social Media</h2>
            <Link to='https://www.instagram.com/laza_photos/'>Instagram</Link>
            <Link to='https://www.facebook.com/leonardo.zambrana.9'>Facebook</Link>
        ...
        <div class='social-media-wrap'>
          ...
          <div class='social-icons'>
            <Link
              ...
              to='https://www.facebook.com/leonardo.zambrana.9'
              target='_blank'
              aria-label='Facebook'
            >
            ...
            <Link
              ...
              to='https://www.instagram.com/laza_photos/'
              target='_blank'
